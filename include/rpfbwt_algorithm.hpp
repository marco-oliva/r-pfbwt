...
private:
    ...
    std::vector<pfpds::long_type> read_l1_freq(std::string& l1_prefix, std::size_t l1_d_phrases)
    {
                ...
                else // easy-hard and hard-hard suffixes
                {
                    ...
                    while (not pq.empty())
                    {
                        ...
                        else
                        {
                            ...
                            typedef std::pair<pfpds::long_type, std::pair<std::size_t, std::size_t>> ilist_pq_t;
